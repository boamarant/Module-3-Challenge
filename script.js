...
const displayAverageSalary = function(employeesArray) {
  ...
  const salaries = employeesArray.map((employee) => parseFloat(employee.salary)); // Iterates over each salary value, and ensures the salary inputs are being logged as numbers
